...
export declare type NetworkConfig = ChainCfg | HttpNetworkConfig;
 ...
 */
export declare type EnvironmentExtender = (env: RuntimeEnv) => void;
export declare type ConfigExtender = (config: ResolvedConfig, userConfig: Readonly<Config>) => void;
...
export declare type ActionType<ArgsT extends TaskArguments> = (taskArgs: ArgsT, env: RuntimeEnv, runSuper: RunSuperFunction<ArgsT>) => PromiseAny;
...
export interface Deployer {
     ...
     */
    fundLsig: (name: string, flags: FundASCFlags, payFlags: wtypes.TxParams, scTmplParams?: SCParams) => void;
    /**
...
export declare type StateValue = string | number | bigint;
...
export declare type LogicSig = LogicSigAccount['lsig'];
